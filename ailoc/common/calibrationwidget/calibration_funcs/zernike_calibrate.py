...
def zernike_calibrate_beads(beads_data, parameters: dict):
    ...
    psf_fit_structure.zeimt0 = -1 * psf_fit_structure.refmed / psf_fit_structure.refimm * psf_fit_structure.objStage0
    ...
    # print(errout)
    # utils.viewdata_napari(modelout)
    # cmp_npdata_napari(beads_data, modelout)