...
def deeploc_inference():
    ...
    loc_model_path = '../../results/2023-08-31-16DeepLoc.pt'
    image_path = '../../test/reproduce_efig.4/match_data/1.tif'
    save_path = '../../results/' + \
                os.path.split(loc_model_path)[-1].split('.')[0] + \
                '_'+os.path.split(image_path)[-1].split('.')[0]+'.csv'
    print(save_path)
    ...
    gt_array = ailoc.common.read_csv_array("../../test/reproduce_efig.4/match_data/activations.csv")
