...
import ailoc.common
from ui_applications.deeploc_application.ui_files.ui_deeploc_analyzer import Ui_DeepLoc_Analyzer
from ui_applications.deeploc_application.ui_files.ui_deeploc_learning import Ui_DeepLoc_learning
# from ui_applications.calibrationwidget.calibrationwidget import CalibrationWidget
...
class DeepLoc_Analyzer_Thread(QtCore.QThread):
    ...
    def run(self):
        app_inference(self.loc_model_path,
                                    self.image_path,
                                    self.output_path,
                                    self.time_block_gb,
                                    self.batch_size,
