...
def lunar_synclearning_tubulin_astig_test():
    # analyze the experimental data
    image_path_list = ['../datasets/simu_tubulin/simu_tubulin_astig_ld/1.tif',  # can be a tiff file path or a folder path
                       '../datasets/simu_tubulin/simu_tubulin_astig_md/1.tif',
                       '../datasets/simu_tubulin/simu_tubulin_astig_hd/1.tif', ]
...
if __name__ == '__main__':
    lunar_synclearning_tubulin_astig_test()
