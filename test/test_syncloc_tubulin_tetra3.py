...
def lunar_synclearning():
    ...
    # experiment file is optional for background range estimation
    calib_file = None
    experiment_file = '../datasets/simu_tubulin/simu_tubulin_tetra3_hd/1.tif'
    ...
    # read the ground truth and calculate metrics
    gt_array = ailoc.common.read_csv_array("../datasets/simu_tubulin/simu_tubulin_tetra3_hd/activations.csv")
...
def lunar_ckpoint_train():
    model_name = '../results/2024-10-30-18-45LUNAR_SL.pt'
