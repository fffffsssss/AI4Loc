...
def transloc_train():
    ...
    calib_file = None
    experiment_file = '../datasets/Snow_dataset_fs/snow_astig_md/1.tif'
    ...
    image_path_list = ['../datasets/Snow_dataset_fs/snow_astig_ld', # can be a tiff file path or a folder path
                       '../datasets/Snow_dataset_fs/snow_astig_md',
                       '../datasets/Snow_dataset_fs/snow_astig_hd',]
    gt_path_list = ['../datasets/Snow_dataset_fs/snow_astig_ld/activations.csv',
                    '../datasets/Snow_dataset_fs/snow_astig_md/activations.csv',
                    '../datasets/Snow_dataset_fs/snow_astig_hd/activations.csv',]
...
def transloc_analysis():
    model_name = '../results/2023-10-30-15TransLoc.pt'
