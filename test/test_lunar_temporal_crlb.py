...
def test_lunar_temporal_crlb_astig():
    ...
    for attn_length in attn_length_test:
        ...
        sampler_params_dict = {
            'temporal_attn': True if (attn_length != 1) else False,
...
def test_lunar_temporal_crlb_tetra3():
    attn_length_test = [9,7,5,3,1]
    for attn_length in attn_length_test:
        # manually set psf parameters
...
def test_lunar_temporal_crlb_tetra6():
    # attn_length_test = [9,7,5,3,1]
    attn_length_test = [ 5,]
    for attn_length in attn_length_test:
        # manually set psf parameters
...
if __name__ == '__main__':
    # test_lunar_temporal_crlb_astig()
    # test_lunar_temporal_crlb_tetra3()
    test_lunar_temporal_crlb_tetra6()
