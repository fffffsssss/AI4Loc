...
def deeploc_train():
    ...
    image_path_list = ['../datasets/match_data',  # can be a tiff file path or a folder path
                       '../datasets/mismatch_data1',
                       '../datasets/mismatch_data2', ]
    gt_path_list = ['../datasets/match_data/activations.csv',
                    '../datasets/mismatch_data1/activations.csv',
                    '../datasets/mismatch_data2/activations.csv', ]
