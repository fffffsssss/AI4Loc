...
def lunar_loclearning():
    ...
    calib_file = '../datasets/dmo6Mito_sw20220423/crop_beads/crop_beads_calib_results.mat'
    experiment_file = '../datasets/dmo6Mito_sw20220423/crop_data/crop_roi.tif'
    ...
    if calib_file is not None:
        ...
        psf_params_dict['objstage0'] = -4000  # the objective stage position is different from beads calibration, unit: nm
...
def lunar_synclearning_ckpoint():
    model_name = '../results/2024-12-13-22-49LUNAR_LL.pt'
