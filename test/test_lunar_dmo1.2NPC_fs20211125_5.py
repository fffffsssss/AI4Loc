...
def lunar_loclearning():
    ...
    # calib_file = None
    calib_file = '../datasets/dmo1.2NPC_fs20211125_5/beads_step20/1_calib_results.mat'
...
def lunar_synclearning_ckpoint():
    model_name = '../results/2024-12-03-21-06LUNAR_SL.pt'
    ...
    lunar_analyzer.check_single_frame_output(frame_num=13)
