...
def transloc_train():
    ...
    sampler_params_dict = {
        ...
        'z_range': (-700, 700),
        'bg_range': bg_range if 'bg_range' in locals().keys() else (99, 100),
        'bg_perlin': False,
    }
    ...
    image_path_list = ['../datasets/random_points_astig_fy/hsnr_hd',  # can be a tiff file path or a folder path
                       '../datasets/random_points_astig_fy/hsnr_ld', ]
    gt_path_list = ['../datasets/random_points_astig_fy/hsnr_hd/activations.csv',
                    '../datasets/random_points_astig_fy/hsnr_ld/activations.csv', ]
...
def transloc_analysis():
    model_name = '../results/2023-12-06-19-18TransLoc.pt'
