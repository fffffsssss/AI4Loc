...
def deeploc_tubulin_astig_test():
...
def deeploc_tubulin_tetra3_test():
    # analyze the experimental data
    ...
    for i in range(repeat_times):
        ...
        if calib_file is not None:
            ...
            psf_params_dict['wavelength'] = 670  # wavelength of sample may be different from beads, unit: nm
            psf_params_dict[
                'objstage0'] = -700  # the objective stage position is different from beads calibration, unit: nm
...
def deeploc_tubulin_tetra6_test():
    # analyze the experimental data
...
if __name__ == '__main__':
    deeploc_tubulin_astig_test()
    # deeploc_tubulin_tetra3_test()
    # deeploc_tubulin_tetra6_test()
