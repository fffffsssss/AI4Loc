...
def transloc_analysis():
    model_name = '../results/2024-03-14-09-11TransLoc.pt'
...
def transloc_competitive_analyze():
    model_name = '../results/2024-06-13-18-40TransLoc.pt'
    with open(model_name, 'rb') as f:
        transloc_model = torch.load(f)
    ...
    for image_path, gt_path in zip(image_path_list, gt_path_list):
        ...
        transloc_analyzer = ailoc.common.CompetitiveSmlmDataAnalyzer(
            loc_model=transloc_model,
            tiff_path=image_path,
            output_path=save_path,
            time_block_gb=1,
            batch_size=32,
