...
def lunar_loclearning():
    ...
    for image_path, gt_path in zip(image_path_list, gt_path_list):
        ...
        transloc_analyzer = ailoc.common.SmlmDataAnalyzer(
            loc_model=lunar_model,
...
def lunar_synclearning():
    ...
    # experiment file is optional for background range estimation
    calib_file = None
    experiment_file = '../datasets/simu_tubulin/simu_tubulin_tetra6_hd/1.tif'
...
def lunar_synclearning_ckpoint():
    model_name = '../results/2024-11-06-16-44LUNAR_SL.pt'
...
def lunar_analyze():
    ...
    loc_model_path = '../results/2024-08-05-23-53LUNAR_LL.pt'
    image_path = '../datasets/simu_tubulin/simu_tubulin_tetra6_ld'   # can be a tiff file path or a folder path
    save_path = '../results/' + \
    ...
    # read the ground truth and calculate metrics
    gt_array = ailoc.common.read_csv_array("../datasets/simu_tubulin/simu_tubulin_tetra6_ld/activations.csv")
